...
namespace DynamicObjectMapper.Tests
{
    public class MapperTests
    {
        ...
        public void Map_ShouldMapObject()
        {
            ...
            // Act
            var result = DynamicMapper.Map(sourceApplication, propertyMappings);
        ...
        public void MapXml_ShouldMapObject()
        {
            ...
            // Act
            var result = DynamicMapper.MapXml(sourceApplication, xml);
        ...
        public void Map_ShouldMapNestedObject_WhenSourceIsDynamic()
        {
            ...
            // Act
            var result = DynamicMapper.Map(source, propertyMappings);
